...
function testSumArray() { //eslint-disable-line
  if (sumArray(multArr)[0] === 9 && sumArray(multArr)[1] === '2,3,4 was passed in as an array of numbers, and 9 is their sum.') {
...
function testMultiplyArray() { //eslint-disable-line
  if (multiplyArray(multArr)[0] === 24 && multiplyArray(multArr)[1] === 'The numbers 2,3,4 have a product of 24.') {
